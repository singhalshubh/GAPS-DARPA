...
@.str.4 = private unnamed_addr constant [11 x i8] c"%f,%f, %f\0A\00", align 1
...
6:                                                ; preds = %17, %0
  ...
  br i1 %8, label %9, label %20, !dbg !76
...
9:                                                ; preds = %6
  ...
  %13 = load double, double* %1, align 8, !dbg !83
  %14 = load double, double* %2, align 8, !dbg !84
  %15 = load double, double* %3, align 8, !dbg !85
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.4, i64 0, i64 0), double %13, double %14, double %15), !dbg !86
  br label %17, !dbg !87

17:                                               ; preds = %9
  %18 = load i32, i32* %4, align 4, !dbg !88
  %19 = add nsw i32 %18, 1, !dbg !88
  store i32 %19, i32* %4, align 4, !dbg !88
  br label %6, !dbg !89, !llvm.loop !90
...
!83 = !DILocation(line: 69, column: 26, scope: !78)
!84 = !DILocation(line: 69, column: 28, scope: !78)
!85 = !DILocation(line: 69, column: 31, scope: !78)
!86 = !DILocation(line: 69, column: 5, scope: !78)
!87 = !DILocation(line: 70, column: 3, scope: !78)
!88 = !DILocation(line: 66, column: 26, scope: !74)
!89 = !DILocation(line: 66, column: 3, scope: !74)
!90 = distinct !{!90, !76, !91}
!91 = !DILocation(line: 70, column: 3, scope: !70)
!92 = !DILocation(line: 71, column: 3, scope: !58)
!93 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 74, type: !59, scopeLine: 74, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !9)
!94 = !DILocation(line: 75, column: 10, scope: !93)
!95 = !DILocation(line: 75, column: 3, scope: !93)

...
33:                                               ; preds = %24
  ...
  %35 = call double (...) @get_ewma(), !dbg !191
  store double %35, double* @_handle_request_get_ewma.last_processed_result, align 8, !dbg !192
  %36 = load i32, i32* %9, align 4, !dbg !193
  store i32 %36, i32* @_handle_request_get_ewma.last_processed_error, align 4, !dbg !194
  %37 = load i32, i32* @_handle_request_get_ewma.processed_counter, align 4, !dbg !195
  %38 = shl i32 %37, 2, !dbg !196
  %39 = load i32, i32* @_handle_request_get_ewma.last_processed_error, align 4, !dbg !197
  %40 = shl i32 %39, 1, !dbg !198
  %41 = or i32 %38, %40, !dbg !199
  %42 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 1, !dbg !200
  ...
  %44 = load double, double* @_handle_request_get_ewma.last_processed_result, align 8, !dbg !203
  %45 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 0, !dbg !204
  store double %44, double* %45, align 1, !dbg !205
  %46 = load i8*, i8** @_handle_request_get_ewma.psocket, align 8, !dbg !206
  %47 = bitcast %struct._response_get_ewma_datatype* %6 to i8*, !dbg !207
  call void @xdc_asyn_send(i8* %46, i8* %47, %struct._tag* %4), !dbg !208
  br label %81, !dbg !209

48:                                               ; preds = %24
  %49 = load i32, i32* %8, align 4, !dbg !210
  %50 = load i32, i32* @_handle_request_get_ewma.processed_counter, align 4, !dbg !212
  %51 = icmp eq i32 %49, %50, !dbg !213
  br i1 %51, label %52, label %64, !dbg !214

52:                                               ; preds = %48
  %53 = load i32, i32* @_handle_request_get_ewma.processed_counter, align 4, !dbg !215
  %54 = shl i32 %53, 2, !dbg !217
  %55 = load i32, i32* @_handle_request_get_ewma.last_processed_error, align 4, !dbg !218
  %56 = shl i32 %55, 1, !dbg !219
  %57 = or i32 %54, %56, !dbg !220
  %58 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 1, !dbg !221
  ...
  %60 = load double, double* @_handle_request_get_ewma.last_processed_result, align 8, !dbg !224
  %61 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 0, !dbg !225
  store double %60, double* %61, align 1, !dbg !226
  %62 = load i8*, i8** @_handle_request_get_ewma.psocket, align 8, !dbg !227
  %63 = bitcast %struct._response_get_ewma_datatype* %6 to i8*, !dbg !228
...
67:                                               ; preds = %64
  %68 = load i32, i32* @_handle_request_get_ewma.processed_counter, align 4, !dbg !235
  %69 = shl i32 %68, 2, !dbg !237
  %70 = load i32, i32* @_handle_request_get_ewma.last_processed_error, align 4, !dbg !238
  %71 = shl i32 %70, 1, !dbg !239
  %72 = or i32 %69, %71, !dbg !240
  %73 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 1, !dbg !241
  ...
  %75 = load double, double* @_handle_request_get_ewma.last_processed_result, align 8, !dbg !244
  %76 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 0, !dbg !245
  store double %75, double* %76, align 1, !dbg !246
  %77 = load i8*, i8** @_handle_request_get_ewma.psocket, align 8, !dbg !247
  %78 = bitcast %struct._response_get_ewma_datatype* %6 to i8*, !dbg !248
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @_wrapper_request_get_ewma(i8* %0) #0 !dbg !260 {
  %2 = alloca i8*, align 8
  store i8* %0, i8** %2, align 8
...
3:                                                ; preds = %1, %3
  ...
  call void @_handle_request_get_ewma(%struct._tag* %5), !dbg !263
...
define dso_local i32 @_slave_rpc_loop() #0 !dbg !266 {
  ...
  %9 = call i32 @pthread_create(i64* %7, %union.pthread_attr_t* null, i8* (i8*)* @_wrapper_request_get_ewma, i8* %8) #6, !dbg !285
...
!74 = !DIFile(filename: "./partitioned/multithreaded/autogen/codec.h", directory: "/workspaces/build/apps/examples/example3")
...
!147 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_request_get_ewma_datatype", file: !74, line: 58, size: 160, elements: !148)
!148 = !{!149, !150}
...
!195 = !DILocation(line: 313, column: 36, scope: !187)
!196 = !DILocation(line: 313, column: 54, scope: !187)
!197 = !DILocation(line: 313, column: 61, scope: !187)
!198 = !DILocation(line: 313, column: 82, scope: !187)
!199 = !DILocation(line: 313, column: 59, scope: !187)
!200 = !DILocation(line: 313, column: 22, scope: !187)
!201 = !DILocation(line: 313, column: 30, scope: !187)
!202 = !DILocation(line: 313, column: 34, scope: !187)
!203 = !DILocation(line: 314, column: 28, scope: !187)
!204 = !DILocation(line: 314, column: 22, scope: !187)
!205 = !DILocation(line: 314, column: 26, scope: !187)
...
!215 = !DILocation(line: 319, column: 76, scope: !216)
!216 = distinct !DILexicalBlock(scope: !211, file: !3, line: 319, column: 40)
!217 = !DILocation(line: 319, column: 94, scope: !216)
!218 = !DILocation(line: 319, column: 101, scope: !216)
!219 = !DILocation(line: 319, column: 122, scope: !216)
!220 = !DILocation(line: 319, column: 99, scope: !216)
!221 = !DILocation(line: 319, column: 62, scope: !216)
!222 = !DILocation(line: 319, column: 70, scope: !216)
!223 = !DILocation(line: 319, column: 74, scope: !216)
!224 = !DILocation(line: 320, column: 28, scope: !216)
!225 = !DILocation(line: 320, column: 22, scope: !216)
!226 = !DILocation(line: 320, column: 26, scope: !216)
...
!235 = !DILocation(line: 326, column: 36, scope: !236)
!236 = distinct !DILexicalBlock(scope: !232, file: !3, line: 325, column: 30)
!237 = !DILocation(line: 326, column: 54, scope: !236)
!238 = !DILocation(line: 326, column: 61, scope: !236)
!239 = !DILocation(line: 326, column: 82, scope: !236)
!240 = !DILocation(line: 326, column: 59, scope: !236)
!241 = !DILocation(line: 326, column: 22, scope: !236)
!242 = !DILocation(line: 326, column: 30, scope: !236)
!243 = !DILocation(line: 326, column: 34, scope: !236)
!244 = !DILocation(line: 327, column: 28, scope: !236)
!245 = !DILocation(line: 327, column: 22, scope: !236)
!246 = !DILocation(line: 327, column: 26, scope: !236)
...
!260 = distinct !DISubprogram(name: "_wrapper_request_get_ewma", scope: !3, file: !3, line: 337, type: !253, scopeLine: 337, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !19, retainedNodes: !21)
...
!284 = !DILocation(line: 344, column: 62, scope: !266)

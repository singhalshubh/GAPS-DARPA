...
39:                                               ; preds = %38, %33
  %40 = call double (...) @get_ewma(), !dbg !207
  store double %40, double* @_handle_request_get_ewma.last_processed_result, align 8, !dbg !208
  %41 = load i8, i8* %9, align 1, !dbg !209
  %42 = trunc i8 %41 to i1, !dbg !209
  %43 = zext i1 %42 to i32, !dbg !209
  store i32 %43, i32* @_handle_request_get_ewma.last_processed_error, align 4, !dbg !210
  store i32 -1, i32* @_handle_request_get_ewma.restart_state, align 4, !dbg !211
  store i8 0, i8* @caller_restarted_get_ewma, align 1, !dbg !212
  %44 = load i32, i32* @_handle_request_get_ewma.processed_counter, align 4, !dbg !213
  %45 = shl i32 %44, 2, !dbg !214
  %46 = load i32, i32* @_handle_request_get_ewma.last_processed_error, align 4, !dbg !215
  %47 = shl i32 %46, 1, !dbg !216
  %48 = or i32 %45, %47, !dbg !217
  %49 = load i32, i32* @_handle_request_get_ewma.callee_restarted, align 4, !dbg !218
  %50 = or i32 %48, %49, !dbg !219
  %51 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 1, !dbg !220
  ...
  %53 = load double, double* @_handle_request_get_ewma.last_processed_result, align 8, !dbg !223
  %54 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 0, !dbg !224
  store double %53, double* %54, align 1, !dbg !225
  %55 = load i8*, i8** @_handle_request_get_ewma.psocket, align 8, !dbg !226
  %56 = bitcast %struct._response_get_ewma_datatype* %6 to i8*, !dbg !227
  call void @xdc_asyn_send(i8* %55, i8* %56, %struct._tag* %4), !dbg !228
  br label %96, !dbg !229

57:                                               ; preds = %24
  %58 = load i32, i32* %8, align 4, !dbg !230
  %59 = load i32, i32* @_handle_request_get_ewma.processed_counter, align 4, !dbg !232
  %60 = icmp eq i32 %58, %59, !dbg !233
  br i1 %60, label %61, label %75, !dbg !234

61:                                               ; preds = %57
  %62 = load i32, i32* @_handle_request_get_ewma.processed_counter, align 4, !dbg !235
  %63 = shl i32 %62, 2, !dbg !237
  %64 = load i32, i32* @_handle_request_get_ewma.last_processed_error, align 4, !dbg !238
  %65 = shl i32 %64, 1, !dbg !239
  %66 = or i32 %63, %65, !dbg !240
  %67 = load i32, i32* @_handle_request_get_ewma.callee_restarted, align 4, !dbg !241
  %68 = or i32 %66, %67, !dbg !242
  %69 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 1, !dbg !243
  ...
  %71 = load double, double* @_handle_request_get_ewma.last_processed_result, align 8, !dbg !246
  %72 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 0, !dbg !247
  store double %71, double* %72, align 1, !dbg !248
  %73 = load i8*, i8** @_handle_request_get_ewma.psocket, align 8, !dbg !249
  %74 = bitcast %struct._response_get_ewma_datatype* %6 to i8*, !dbg !250
...
78:                                               ; preds = %75
  %79 = load i32, i32* @_handle_request_get_ewma.processed_counter, align 4, !dbg !257
  %80 = shl i32 %79, 2, !dbg !259
  %81 = load i32, i32* @_handle_request_get_ewma.last_processed_error, align 4, !dbg !260
  %82 = shl i32 %81, 1, !dbg !261
  %83 = or i32 %80, %82, !dbg !262
  %84 = load i32, i32* @_handle_request_get_ewma.callee_restarted, align 4, !dbg !263
  %85 = or i32 %83, %84, !dbg !264
  %86 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 1, !dbg !265
  ...
  %88 = load double, double* @_handle_request_get_ewma.last_processed_result, align 8, !dbg !268
  %89 = getelementptr inbounds %struct._response_get_ewma_datatype, %struct._response_get_ewma_datatype* %6, i32 0, i32 0, !dbg !269
  store double %88, double* %89, align 1, !dbg !270
  %90 = load i32, i32* @_handle_request_get_ewma.processed_counter, align 4, !dbg !271
  %91 = add nsw i32 %90, 1, !dbg !272
  store i32 %91, i32* @_handle_request_get_ewma.restart_state, align 4, !dbg !273
  %92 = load i8*, i8** @_handle_request_get_ewma.psocket, align 8, !dbg !274
  %93 = bitcast %struct._response_get_ewma_datatype* %6 to i8*, !dbg !275
...
96:                                               ; preds = %95, %39
  store i32 0, i32* @_handle_request_get_ewma.callee_restarted, align 4, !dbg !278
  ret void, !dbg !279
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @_wrapper_request_get_ewma(i8* %0) #0 !dbg !288 {
  %2 = alloca i8*, align 8
  store i8* %0, i8** %2, align 8
...
3:                                                ; preds = %1, %3
  ...
  call void @_handle_request_get_ewma(%struct._tag* %5), !dbg !291
...
define dso_local i32 @_slave_rpc_loop() #0 !dbg !294 {
  ...
  %9 = call i32 @pthread_create(i64* %7, %union.pthread_attr_t* null, i8* (i8*)* @_wrapper_request_get_ewma, i8* %8) #6, !dbg !313
...
!20 = !DIFile(filename: "partitioned/multithreaded/orange/orange_rpc.c", directory: "/workspaces/build/apps/examples/example3")
!21 = !{}
!22 = !{!23}
...
!52 = !DIFile(filename: "./partitioned/multithreaded/orange/orange_rpc.h", directory: "/workspaces/build/apps/examples/example3")
...
!82 = !DIFile(filename: "./partitioned/multithreaded/autogen/codec.h", directory: "/workspaces/build/apps/examples/example3")
...
!155 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_request_get_ewma_datatype", file: !82, line: 58, size: 160, elements: !156)
!156 = !{!157, !158}
...
!212 = !DILocation(line: 262, column: 35, scope: !196)
!213 = !DILocation(line: 263, column: 36, scope: !196)
!214 = !DILocation(line: 263, column: 54, scope: !196)
!215 = !DILocation(line: 263, column: 61, scope: !196)
!216 = !DILocation(line: 263, column: 82, scope: !196)
!217 = !DILocation(line: 263, column: 59, scope: !196)
!218 = !DILocation(line: 263, column: 89, scope: !196)
!219 = !DILocation(line: 263, column: 87, scope: !196)
!220 = !DILocation(line: 263, column: 22, scope: !196)
!221 = !DILocation(line: 263, column: 30, scope: !196)
!222 = !DILocation(line: 263, column: 34, scope: !196)
!223 = !DILocation(line: 264, column: 28, scope: !196)
!224 = !DILocation(line: 264, column: 22, scope: !196)
!225 = !DILocation(line: 264, column: 26, scope: !196)
...
!235 = !DILocation(line: 269, column: 76, scope: !236)
!236 = distinct !DILexicalBlock(scope: !231, file: !3, line: 269, column: 40)
!237 = !DILocation(line: 269, column: 94, scope: !236)
!238 = !DILocation(line: 269, column: 101, scope: !236)
!239 = !DILocation(line: 269, column: 122, scope: !236)
!240 = !DILocation(line: 269, column: 99, scope: !236)
!241 = !DILocation(line: 269, column: 129, scope: !236)
!242 = !DILocation(line: 269, column: 127, scope: !236)
!243 = !DILocation(line: 269, column: 62, scope: !236)
!244 = !DILocation(line: 269, column: 70, scope: !236)
!245 = !DILocation(line: 269, column: 74, scope: !236)
!246 = !DILocation(line: 270, column: 28, scope: !236)
!247 = !DILocation(line: 270, column: 22, scope: !236)
!248 = !DILocation(line: 270, column: 26, scope: !236)
...
!257 = !DILocation(line: 276, column: 36, scope: !258)
!258 = distinct !DILexicalBlock(scope: !254, file: !3, line: 275, column: 30)
!259 = !DILocation(line: 276, column: 54, scope: !258)
!260 = !DILocation(line: 276, column: 61, scope: !258)
!261 = !DILocation(line: 276, column: 82, scope: !258)
!262 = !DILocation(line: 276, column: 59, scope: !258)
!263 = !DILocation(line: 276, column: 89, scope: !258)
!264 = !DILocation(line: 276, column: 87, scope: !258)
!265 = !DILocation(line: 276, column: 22, scope: !258)
!266 = !DILocation(line: 276, column: 30, scope: !258)
!267 = !DILocation(line: 276, column: 34, scope: !258)
!268 = !DILocation(line: 277, column: 28, scope: !258)
!269 = !DILocation(line: 277, column: 22, scope: !258)
!270 = !DILocation(line: 277, column: 26, scope: !258)
...
!288 = distinct !DISubprogram(name: "_wrapper_request_get_ewma", scope: !3, file: !3, line: 289, type: !281, scopeLine: 289, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !19, retainedNodes: !21)
...
!312 = !DILocation(line: 296, column: 62, scope: !294)

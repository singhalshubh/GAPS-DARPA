...
define dso_local i32 @ewma_main() #0 !dbg !51 {
  ...
  call void @llvm.var.annotation(i8* %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.1.4, i32 0, i32 0), i32 46), !dbg !61
...
!14 = !DIFile(filename: "./divvied/purple/example1.mod.c", directory: "/workspaces/build/apps/examples/example1")
...
!16 = !DIFile(filename: "divvied/purple/example1.mod.c", directory: "/workspaces/build/apps/examples/example1")
!17 = !{!18, !11}
